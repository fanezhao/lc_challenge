...
<p> </p>
<div><div>Related Topics</div><div><li>数组</li><li>双指针</li></div></div><br><div><li>👍 2412</li><li>👎 0</li></div>
*/
...
public class Q26RemoveDuplicatesFromSortedArray {
    public static void main(String[] args) {
        ...
        int[] arr3 = {1};
        System.out.println(solution.removeDuplicates(arr3));
    }
    ...
    class Solution {
        ...
        /**
         * 个人思路：使用双指针。开始时，头尾指针均指向头元素，然后尾指针每次向前移动。
         * 然后尾指针指向的值和头指针指向的针进行比较：
         * 当两值不相等时，说明尾指针已经指向了一个新的元素，这里把尾指针的值放在头指针的下一位，同时头指针+1。
         * 当尾指针遍历到最后时，头指针就指向不重复的末尾。这里取其+1即是不重复数据的长度。
         * @param nums
         * @return
         */
